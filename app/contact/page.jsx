          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                ...
                presse subventionnée par l'État ne va plus... Nul besoin d'avoir
                un compte PayPal pour participer!
              </p>
              <a
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <p className="text-sm text-gray-500">
                    Mon Facebook avec 67 000 abonnés a été censuré la veille du
                    1er tour des élections régionales de décembre 2015.
                  </p>
                  <a
