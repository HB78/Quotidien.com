    ...
    <main className="container mx-auto px-4 py-8 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-800 text-white rounded-xl p-8 mb-12 shadow-lg">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl">
            L'évolution du cours des actions des principales banques entre 2007
            et 2025. La Loi "Jovanovic" signifie que les banques ne peuvent pas
            tromper leurs propres traders.
          </p>
        </div>
      </section>
        ...
        <article className="bg-gradient-to-br from-red-50 to-white rounded-xl p-8 mb-12 shadow-lg border border-red-100">
          <header>
            ...
            <p className="text-lg text-red-800 mb-8">
              ...
              des économistes qui n'ont pas vu la catastrophe économique arriver
              alors qu'ils la regardaient droit dans les yeux.
            </p>
          </header>
                ...
                >
                  <header className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{economist.title}</p>
                    </div>
